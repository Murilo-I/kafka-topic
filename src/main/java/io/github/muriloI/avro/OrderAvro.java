 ...
 */
package io.github.muriloI.avro;
...
public class OrderAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -291910988444950876L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderAvro\",\"namespace\":\"io.github.muriloI.avro\",\"fields\":[{\"name\":\"customerName\",\"type\":\"string\"},{\"name\":\"product\",\"type\":\"string\"},{\"name\":\"quantity\",\"type\":\"int\"}]}");
   ...
   */
  public OrderAvro(java.lang.CharSequence customerName, java.lang.CharSequence product, java.lang.Integer quantity) {
   ...
   */
  public static io.github.muriloI.avro.OrderAvro.Builder newBuilder() {
    return new io.github.muriloI.avro.OrderAvro.Builder();
  }
   ...
   * @return A new OrderAvro RecordBuilder
   */
  public static io.github.muriloI.avro.OrderAvro.Builder newBuilder(io.github.muriloI.avro.OrderAvro.Builder other) {
    if (other == null) {
      return new io.github.muriloI.avro.OrderAvro.Builder();
    } else {
      return new io.github.muriloI.avro.OrderAvro.Builder(other);
    }
  }
   ...
   * @return A new OrderAvro RecordBuilder
   */
  public static io.github.muriloI.avro.OrderAvro.Builder newBuilder(io.github.muriloI.avro.OrderAvro other) {
    if (other == null) {
      return new io.github.muriloI.avro.OrderAvro.Builder();
    } else {
      return new io.github.muriloI.avro.OrderAvro.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderAvro>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.github.muriloI.avro.OrderAvro.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.github.muriloI.avro.OrderAvro other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.customerName)) {
        this.customerName = data().deepCopy(fields()[0].schema(), other.customerName);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.github.muriloI.avro.OrderAvro.Builder setCustomerName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.github.muriloI.avro.OrderAvro.Builder clearCustomerName() {
      customerName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.github.muriloI.avro.OrderAvro.Builder setProduct(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.github.muriloI.avro.OrderAvro.Builder clearProduct() {
      product = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.github.muriloI.avro.OrderAvro.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.github.muriloI.avro.OrderAvro.Builder clearQuantity() {
